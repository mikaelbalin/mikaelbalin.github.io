...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_latest_posts_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_archive_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('posts');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('main', 'blog');
  CREATE TYPE "public"."enum_pages_hero_contact_link_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_archive_latest_posts_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_archive_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('posts');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('main', 'blog');
  CREATE TYPE "public"."enum__pages_v_version_hero_contact_link_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('en', 'pt');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('en', 'pt');
  CREATE TYPE "public"."enum_redirects_to_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_forms_confirmation_type" AS ENUM('message', 'redirect');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_header_logo_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_social_social_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_navigation_nav_items_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_archive" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"latest_posts_link_type" "enum_pages_blocks_archive_latest_posts_link_type" DEFAULT 'custom',
  	"latest_posts_link_new_tab" boolean,
  	"latest_posts_link_url" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_archive_locales" (
  	"title" varchar,
  	"latest_posts_link_label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_reusable_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages" (
  	...
  	"hero_titles" jsonb,
  	"hero_contact_link_link_type" "enum_pages_hero_contact_link_link_type" DEFAULT 'custom',
  	"hero_contact_link_link_new_tab" boolean,
  	"hero_contact_link_link_url" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_locales" (
  	...
  	"hero_contact_link_link_label" varchar,
  	"meta_title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_about_locales" (
  	"title" varchar,
  	"description" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_archive" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"latest_posts_link_type" "enum__pages_v_blocks_archive_latest_posts_link_type" DEFAULT 'custom',
  	"latest_posts_link_new_tab" boolean,
  	"latest_posts_link_url" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_search" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_search_locales" (
  	"title" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_reusable_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v" (
  	...
  	"version_hero_contact_link_link_type" "enum__pages_v_version_hero_contact_link_link_type" DEFAULT 'custom',
  	"version_hero_contact_link_link_new_tab" boolean,
  	"version_hero_contact_link_link_url" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_locales" (
  	...
  	"version_hero_contact_link_link_label" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "posts" (
  	...
  	"slug" varchar,
  	"slug_lock" boolean DEFAULT true,
  	"time_to_read" numeric DEFAULT 1,
  	"time_to_read_lock" boolean DEFAULT true,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_posts_v" (
  	...
  	"version_slug" varchar,
  	"version_slug_lock" boolean DEFAULT true,
  	"version_time_to_read" numeric DEFAULT 1,
  	"version_time_to_read_lock" boolean DEFAULT true,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE IF NOT EXISTS "reusable_blocks_blocks_form_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "reusable_blocks_blocks_form_block_locales" (
  ...
  CREATE TABLE IF NOT EXISTS "reusable_blocks_blocks_subscription" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "reusable_blocks_blocks_subscription_locales" (
  	"title" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_link_type" "enum_header_logo_link_type" DEFAULT 'custom',
  ...
  CREATE TABLE IF NOT EXISTS "header_locales" (
  	"logo_link_label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "footer_social_social_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_social_social_items_link_type" DEFAULT 'custom',
  	"link_new_tab" boolean,
  	"link_url" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "footer_social_social_items_locales" (
  	"link_label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "footer_blocks_form_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "footer_blocks_form_block_locales" (
  	"form_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "footer_navigation_nav_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_navigation_nav_items_link_type" DEFAULT 'custom',
  	"link_new_tab" boolean,
  	"link_url" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "footer_navigation_nav_items_locales" (
  	"link_label" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "footer_locales" (
  	...
  	"navigation_title" varchar,
  	"navigation_top_button" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_reusable_block" ADD CONSTRAINT "pages_blocks_reusable_block_block_id_reusable_blocks_id_fk" FOREIGN KEY ("block_id") REFERENCES "public"."reusable_blocks"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_search" ADD CONSTRAINT "_pages_v_blocks_search_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_search_locales" ADD CONSTRAINT "_pages_v_blocks_search_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_search"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_reusable_block" ADD CONSTRAINT "_pages_v_blocks_reusable_block_block_id_reusable_blocks_id_fk" FOREIGN KEY ("block_id") REFERENCES "public"."reusable_blocks"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "reusable_blocks_blocks_form_block" ADD CONSTRAINT "reusable_blocks_blocks_form_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."reusable_blocks"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "reusable_blocks_blocks_form_block_locales" ADD CONSTRAINT "reusable_blocks_blocks_form_block_locales_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "reusable_blocks_blocks_form_block_locales" ADD CONSTRAINT "reusable_blocks_blocks_form_block_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."reusable_blocks_blocks_form_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "reusable_blocks_blocks_subscription" ADD CONSTRAINT "reusable_blocks_blocks_subscription_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."reusable_blocks"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "reusable_blocks_blocks_subscription_locales" ADD CONSTRAINT "reusable_blocks_blocks_subscription_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."reusable_blocks_blocks_subscription"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "footer_social_social_items" ADD CONSTRAINT "footer_social_social_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "footer_social_social_items_locales" ADD CONSTRAINT "footer_social_social_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_social_social_items"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "footer_blocks_form_block_locales" ADD CONSTRAINT "footer_blocks_form_block_locales_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "footer_blocks_form_block_locales" ADD CONSTRAINT "footer_blocks_form_block_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_blocks_form_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "footer_navigation_nav_items" ADD CONSTRAINT "footer_navigation_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "footer_navigation_nav_items_locales" ADD CONSTRAINT "footer_navigation_nav_items_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_navigation_nav_items"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "pages_blocks_archive_locales_locale_parent_id_unique" ON "pages_blocks_archive_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "pages_blocks_search_locales_locale_parent_id_unique" ON "pages_blocks_search_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_reusable_block_order_idx" ON "pages_blocks_reusable_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_reusable_block_parent_id_idx" ON "pages_blocks_reusable_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_reusable_block_path_idx" ON "pages_blocks_reusable_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_reusable_block_block_idx" ON "pages_blocks_reusable_block" USING btree ("block_id");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "_pages_v_blocks_about_locales_locale_parent_id_unique" ON "_pages_v_blocks_about_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "_pages_v_blocks_archive_locales_locale_parent_id_unique" ON "_pages_v_blocks_archive_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_search_order_idx" ON "_pages_v_blocks_search" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_search_parent_id_idx" ON "_pages_v_blocks_search" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_search_path_idx" ON "_pages_v_blocks_search" USING btree ("_path");
  CREATE UNIQUE INDEX IF NOT EXISTS "_pages_v_blocks_search_locales_locale_parent_id_unique" ON "_pages_v_blocks_search_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_reusable_block_order_idx" ON "_pages_v_blocks_reusable_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_reusable_block_parent_id_idx" ON "_pages_v_blocks_reusable_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_reusable_block_path_idx" ON "_pages_v_blocks_reusable_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_reusable_block_block_idx" ON "_pages_v_blocks_reusable_block" USING btree ("block_id");
  ...
  CREATE INDEX IF NOT EXISTS "posts_time_to_read_idx" ON "posts" USING btree ("time_to_read");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_version_version_time_to_read_idx" ON "_posts_v" USING btree ("version_time_to_read");
  ...
  CREATE INDEX IF NOT EXISTS "reusable_blocks_blocks_form_block_order_idx" ON "reusable_blocks_blocks_form_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_blocks_form_block_parent_id_idx" ON "reusable_blocks_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_blocks_form_block_path_idx" ON "reusable_blocks_blocks_form_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_blocks_form_block_form_idx" ON "reusable_blocks_blocks_form_block_locales" USING btree ("form_id","_locale");
  CREATE UNIQUE INDEX IF NOT EXISTS "reusable_blocks_blocks_form_block_locales_locale_parent_id_unique" ON "reusable_blocks_blocks_form_block_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_blocks_subscription_order_idx" ON "reusable_blocks_blocks_subscription" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_blocks_subscription_parent_id_idx" ON "reusable_blocks_blocks_subscription" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_blocks_subscription_path_idx" ON "reusable_blocks_blocks_subscription" USING btree ("_path");
  CREATE UNIQUE INDEX IF NOT EXISTS "reusable_blocks_blocks_subscription_locales_locale_parent_id_unique" ON "reusable_blocks_blocks_subscription_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_updated_at_idx" ON "reusable_blocks" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "reusable_blocks_created_at_idx" ON "reusable_blocks" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_reusable_blocks_id_idx" ON "payload_locked_documents_rels" USING btree ("reusable_blocks_id");
  ...
  CREATE INDEX IF NOT EXISTS "footer_social_social_items_order_idx" ON "footer_social_social_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_social_social_items_parent_id_idx" ON "footer_social_social_items" USING btree ("_parent_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "footer_social_social_items_locales_locale_parent_id_unique" ON "footer_social_social_items_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "footer_blocks_form_block_order_idx" ON "footer_blocks_form_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_blocks_form_block_parent_id_idx" ON "footer_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "footer_blocks_form_block_path_idx" ON "footer_blocks_form_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "footer_blocks_form_block_form_idx" ON "footer_blocks_form_block_locales" USING btree ("form_id","_locale");
  CREATE UNIQUE INDEX IF NOT EXISTS "footer_blocks_form_block_locales_locale_parent_id_unique" ON "footer_blocks_form_block_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "footer_navigation_nav_items_order_idx" ON "footer_navigation_nav_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_navigation_nav_items_parent_id_idx" ON "footer_navigation_nav_items" USING btree ("_parent_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "footer_navigation_nav_items_locales_locale_parent_id_unique" ON "footer_navigation_nav_items_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_search" CASCADE;
  DROP TABLE "pages_blocks_search_locales" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_search" CASCADE;
  DROP TABLE "_pages_v_blocks_search_locales" CASCADE;
  ...
  DROP TABLE "reusable_blocks_blocks_form_block" CASCADE;
  DROP TABLE "reusable_blocks_blocks_form_block_locales" CASCADE;
  DROP TABLE "reusable_blocks_blocks_subscription" CASCADE;
  DROP TABLE "reusable_blocks_blocks_subscription_locales" CASCADE;
  ...
  DROP TABLE "footer_social_social_items" CASCADE;
  DROP TABLE "footer_social_social_items_locales" CASCADE;
  DROP TABLE "footer_blocks_form_block" CASCADE;
  DROP TABLE "footer_blocks_form_block_locales" CASCADE;
  DROP TABLE "footer_navigation_nav_items" CASCADE;
  DROP TABLE "footer_navigation_nav_items_locales" CASCADE;
  DROP TABLE "footer" CASCADE;
  DROP TABLE "footer_locales" CASCADE;
  DROP TABLE "footer_rels" CASCADE;
  DROP TYPE "public"."_locales";
  DROP TYPE "public"."enum_pages_blocks_archive_latest_posts_link_type";
  DROP TYPE "public"."enum_pages_blocks_archive_populate_by";
  DROP TYPE "public"."enum_pages_blocks_archive_relation_to";
  DROP TYPE "public"."enum_pages_hero_type";
  DROP TYPE "public"."enum_pages_hero_contact_link_link_type";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_blocks_archive_latest_posts_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_archive_populate_by";
  DROP TYPE "public"."enum__pages_v_blocks_archive_relation_to";
  DROP TYPE "public"."enum__pages_v_version_hero_type";
  DROP TYPE "public"."enum__pages_v_version_hero_contact_link_link_type";
  ...
  DROP TYPE "public"."enum_footer_social_social_items_link_type";
  DROP TYPE "public"."enum_footer_navigation_nav_items_link_type";`)
}
