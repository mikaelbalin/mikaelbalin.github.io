...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_archive" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"latest_posts_link_type" "enum_pages_blocks_archive_latest_posts_link_type" DEFAULT 'reference',
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_archive" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"latest_posts_link_type" "enum__pages_v_blocks_archive_latest_posts_link_type" DEFAULT 'reference',
  	"latest_posts_link_new_tab" boolean,
  	"latest_posts_link_url" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_link_type" "enum_header_logo_link_type" DEFAULT 'reference',
  ...
  CREATE TABLE IF NOT EXISTS "footer_social_social_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_social_social_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "footer_navigation_nav_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_navigation_nav_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar
  );
