...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_subscription" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_subscription" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_subscription" ADD CONSTRAINT "pages_blocks_subscription_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_subscription" ADD CONSTRAINT "_pages_v_blocks_subscription_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_subscription_order_idx" ON "pages_blocks_subscription" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_subscription_parent_id_idx" ON "pages_blocks_subscription" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_subscription_path_idx" ON "pages_blocks_subscription" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_subscription_order_idx" ON "_pages_v_blocks_subscription" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_subscription_parent_id_idx" ON "_pages_v_blocks_subscription" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_subscription_path_idx" ON "_pages_v_blocks_subscription" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "footer_blocks_form_block_form_idx" ON "footer_blocks_form_block" USING btree ("form_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_subscription" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_subscription" CASCADE;
