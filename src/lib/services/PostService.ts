...
export class PostService {
  ...
  static readonly getBySlug = cache(async ({ slug }: PostQueryArgs) => {
  ...
  static readonly getPostLayoutData = cache(
  ...
  static readonly queryArchivePosts = cache(async (args: ArchivePostsArgs) => {
